...
public class UI {
  ...
  public static void createAndShowGUI() {
    ...
    JPanel inputPanel = uiComponents.createInputPanel(frame, gbc, indexBox, stockBox, startDateChooser, endDateChooser, showMA, periodLengthLabel, periodLengthField, submitButton, countLabel);
    ...
    // Create an empty news panel and add it to the main panel
    JPanel newsPanel = new JPanel(new BorderLayout());
    newsPanel.setPreferredSize(new Dimension(400, 600));
    mainPanel.add(newsPanel, BorderLayout.EAST);
    ...
    submitButton.addActionListener(e -> {
      try {
        eventHandlers.handleSubmit(frame, stockBox, startDateChooser, endDateChooser, periodLengthField, chartPanel, newsPanel);
